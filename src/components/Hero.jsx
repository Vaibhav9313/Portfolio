    ...
    <div className='border-b border-neutral-900 pb-4 lg:mb-35'>
        <div className='flex flex-wrap'>
            <div className='w-full lg:w-1/2'>
                <div className='flex flex-col items-start ml-5 lg:items-start'>
                    <motion.h1 
                        variants={container(0)}
                        initial="hidden"
                        animate="visible"
                        className='pb-6 text-4xl font-thin tracking-tight lg:mt-16 lg:text-6xl'>
                        Vaibhav Jadhav
                    </motion.h1>
                    <motion.span 
